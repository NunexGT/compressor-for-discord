...
#it will be defined in the .cmd in which will execute the compressor
if video_compression_target is None:
    ...
    print("Under Development... Please verify if you have the right files installed")
...
def compressGif(clip_path):
    ...
    gifs_path = userprofile_path + '\AppData\Local\Temp\Compressor4Discord\ ' 
